...
//     if (name === "email") {
//       if (checkEmailHasSpecial(value) || !value.includes("@")) {
//         setErrorState({ email: "Invalid email format." });
//       } else {
//         setErrorState({ email: "" });
//       }
//     }
...
//   const handleNextStep = () => {
//     if (!errorState.email && catchToken.email) setStep(step + 1);
//   };

//   const disabled = !catchToken.email || errorState.email;
...
//             <p className="text-[23px] font-medium">Create your account</p>
...
//               value={catchToken.email}
//               errors={errorState.email}
//               errorsMess="Invalid email format"
//               place="Enter your email address"
//             />
